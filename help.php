...
if ($query_customer->numRows() > 0) {
	...
	if ($customer['invoice'] != "") {
		...
		$raw = array('<', '>');
		$friendly = array('&lt;', '&gt;');
		$html_item_list = str_replace($raw, $friendly, $html_item_list);
		*/
	}
}	
...
<table  id="mod_bakery_placeholders_b" width="100%" cellpadding="5" cellspacing="0">
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_items_b"><?php echo (isset($item['modified_when']) ? date(DATE_FORMAT, $item['modified_when']) : "&nbsp;"); ?></td>
  </tr>
  <tr valign="top">
    <td>[DESCRIPTION]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
  ...
  <tr valign="top">
    ...
    <td>IH</td>
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Displays whether price includes VAT, excludes VAT, or is free of VAT (according to Global Settings)</td>
    <td class="mod_bakery_placeholders_items_b"><?php if ($general_settings['tax_by'] == "none") { echo $MOD_BAKERY['TXT_TAX_FREE']; }
    else { echo ($general_settings['tax_included'] == "included") ? $MOD_BAKERY['TXT_TAX_INCLUDED'] : $MOD_BAKERY['TXT_TAX_EXCLUDED']; } ?></td>
  </tr>
  <tr valign="top">
    <td>[TEXT_OF]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
  ...
  <tr valign="top">
    ...
    <td>IH</td>
    <td class="mod_bakery_placeholders_column_b">IF</td>
    <td>Displays a textarea plus label for free text input by customer</td>
    <td class="mod_bakery_placeholders_items_b">&lt;label for="view_item_textarea"&gt;
<br />Notification
<br />&lt;textarea id="view_item_textarea" rows="5" cols="35" name="view_item_textarea"&gt;&lt;/textarea&gt;
<br />&lt;/label&gt;</td>
  </tr>
  <tr valign="top">
    <td>[TXT_ABROAD]</td>
  ...
  <tr valign="top">
    ...
    <td class="mod_bakery_placeholders_items_b"><?php echo (isset($item['modified_when']) ? date(TIME_FORMAT, $item['modified_when']) : "&nbsp;"); ?></td>
  </tr>
  <tr valign="top">
    <td>[TITLE]</td>
    <td class="mod_bakery_placeholders_column_b">&nbsp;</td>
