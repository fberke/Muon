...
if (defined('WB_URL')) {
	...
	$mod_bakery = "CREATE TABLE `".TABLE_PREFIX."mod_bakery_general_settings` ( "
			...
			. "`cancellation_url` VARCHAR(255) NOT NULL ,"
	...
	$database->query("INSERT INTO ".TABLE_PREFIX."mod_bakery_general_settings (shop_name, tac_url, shop_email) VALUES ('$shop_name', '$tac_url', '$shop_email')");
